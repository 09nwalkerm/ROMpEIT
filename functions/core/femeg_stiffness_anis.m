...
%
%
% Matt's Anisotropy edit:
%
% D must now be in its properly vectorised form:
...
F = [b(:,1).*(b(:,1).*D(:,1)+c(:,1).*D(:,2)+d(:,1).*D(:,3))  +  c(:,1).*(b(:,1).*D(:,4)+c(:,1).*D(:,5)+d(:,1).*D(:,6))  +  d(:,1).*(b(:,1).*D(:,7)+c(:,1).*D(:,8)+d(:,1).*D(:,9)),...
     b(:,1).*(b(:,2).*D(:,1)+c(:,2).*D(:,2)+d(:,2).*D(:,3))  +  c(:,1).*(b(:,2).*D(:,4)+c(:,2).*D(:,5)+d(:,2).*D(:,6))  +  d(:,1).*(b(:,2).*D(:,7)+c(:,2).*D(:,8)+d(:,2).*D(:,9)),...
     b(:,1).*(b(:,3).*D(:,1)+c(:,3).*D(:,2)+d(:,3).*D(:,3))  +  c(:,1).*(b(:,3).*D(:,4)+c(:,3).*D(:,5)+d(:,3).*D(:,6))  +  d(:,1).*(b(:,3).*D(:,7)+c(:,3).*D(:,8)+d(:,3).*D(:,9)),...
     b(:,1).*(b(:,4).*D(:,1)+c(:,4).*D(:,2)+d(:,4).*D(:,3))  +  c(:,1).*(b(:,4).*D(:,4)+c(:,4).*D(:,5)+d(:,4).*D(:,6))  +  d(:,1).*(b(:,4).*D(:,7)+c(:,4).*D(:,8)+d(:,4).*D(:,9)),...
     b(:,2).*(b(:,1).*D(:,1)+c(:,1).*D(:,2)+d(:,1).*D(:,3))  +  c(:,2).*(b(:,1).*D(:,4)+c(:,1).*D(:,5)+d(:,1).*D(:,6))  +  d(:,2).*(b(:,1).*D(:,7)+c(:,1).*D(:,8)+d(:,1).*D(:,9)),...
     b(:,2).*(b(:,2).*D(:,1)+c(:,2).*D(:,2)+d(:,2).*D(:,3))  +  c(:,2).*(b(:,2).*D(:,4)+c(:,2).*D(:,5)+d(:,2).*D(:,6))  +  d(:,2).*(b(:,2).*D(:,7)+c(:,2).*D(:,8)+d(:,2).*D(:,9)),...
     b(:,2).*(b(:,3).*D(:,1)+c(:,3).*D(:,2)+d(:,3).*D(:,3))  +  c(:,2).*(b(:,3).*D(:,4)+c(:,3).*D(:,5)+d(:,3).*D(:,6))  +  d(:,2).*(b(:,3).*D(:,7)+c(:,3).*D(:,8)+d(:,3).*D(:,9)),...
     b(:,2).*(b(:,4).*D(:,1)+c(:,4).*D(:,2)+d(:,4).*D(:,3))  +  c(:,2).*(b(:,4).*D(:,4)+c(:,4).*D(:,5)+d(:,4).*D(:,6))  +  d(:,2).*(b(:,4).*D(:,7)+c(:,4).*D(:,8)+d(:,4).*D(:,9)),...
     b(:,3).*(b(:,1).*D(:,1)+c(:,1).*D(:,2)+d(:,1).*D(:,3))  +  c(:,3).*(b(:,1).*D(:,4)+c(:,1).*D(:,5)+d(:,1).*D(:,6))  +  d(:,3).*(b(:,1).*D(:,7)+c(:,1).*D(:,8)+d(:,1).*D(:,9)),...
     b(:,3).*(b(:,2).*D(:,1)+c(:,2).*D(:,2)+d(:,2).*D(:,3))  +  c(:,3).*(b(:,2).*D(:,4)+c(:,2).*D(:,5)+d(:,2).*D(:,6))  +  d(:,3).*(b(:,2).*D(:,7)+c(:,2).*D(:,8)+d(:,2).*D(:,9)),...
     b(:,3).*(b(:,3).*D(:,1)+c(:,3).*D(:,2)+d(:,3).*D(:,3))  +  c(:,3).*(b(:,3).*D(:,4)+c(:,3).*D(:,5)+d(:,3).*D(:,6))  +  d(:,3).*(b(:,3).*D(:,7)+c(:,3).*D(:,8)+d(:,3).*D(:,9)),...
     b(:,3).*(b(:,4).*D(:,1)+c(:,4).*D(:,2)+d(:,4).*D(:,3))  +  c(:,3).*(b(:,4).*D(:,4)+c(:,4).*D(:,5)+d(:,4).*D(:,6))  +  d(:,3).*(b(:,4).*D(:,7)+c(:,4).*D(:,8)+d(:,4).*D(:,9)),...
     b(:,4).*(b(:,1).*D(:,1)+c(:,1).*D(:,2)+d(:,1).*D(:,3))  +  c(:,4).*(b(:,1).*D(:,4)+c(:,1).*D(:,5)+d(:,1).*D(:,6))  +  d(:,4).*(b(:,1).*D(:,7)+c(:,1).*D(:,8)+d(:,1).*D(:,9)),...
     b(:,4).*(b(:,2).*D(:,1)+c(:,2).*D(:,2)+d(:,2).*D(:,3))  +  c(:,4).*(b(:,2).*D(:,4)+c(:,2).*D(:,5)+d(:,2).*D(:,6))  +  d(:,4).*(b(:,2).*D(:,7)+c(:,2).*D(:,8)+d(:,2).*D(:,9)),...
     b(:,4).*(b(:,3).*D(:,1)+c(:,3).*D(:,2)+d(:,3).*D(:,3))  +  c(:,4).*(b(:,3).*D(:,4)+c(:,3).*D(:,5)+d(:,3).*D(:,6))  +  d(:,4).*(b(:,3).*D(:,7)+c(:,3).*D(:,8)+d(:,3).*D(:,9)),...
     b(:,4).*(b(:,4).*D(:,1)+c(:,4).*D(:,2)+d(:,4).*D(:,3))  +  c(:,4).*(b(:,4).*D(:,4)+c(:,4).*D(:,5)+d(:,4).*D(:,6))  +  d(:,4).*(b(:,4).*D(:,7)+c(:,4).*D(:,8)+d(:,4).*D(:,9))];
