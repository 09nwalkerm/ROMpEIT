...
%   'mu_max',mu_max,'noise',0.82e-6,'anis_rad',2,'anis_tan',3,'angles',true,...
%   'ratio',3,'Cluster',true,'debug',true)

%% Run inverse solutions and error estimator values
% Type `help GenBound` for help and options

%GenBound('sample_num',num_start:num_samples,'max_snap',30,'debug',true)
...
GenInverse('model',model,'ROM',true,'Cluster',true,'sample_num',num_start:num_samples,...
  'active_layers',c,'sensitivity',true,'use_sinks',true,'use_noise',true,'noise',0.82e-6,...
  'tag','sense1','debug',true)

sense = SenseClass('layers',c,'c',c,'layer_names',layer_names,'plot','Box','num_samples',num_start:num_samples);
