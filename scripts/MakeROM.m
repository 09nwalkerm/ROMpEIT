...
mu_min = [0.1359,0.0008,1.3881,0.0598,0.0652,0.0010,1.5,1.5,3.14];
mu_max = [0.6196,0.0131,1.7945,0.7391,0.2283,0.0430,1.5,1.5,3.14];
...
%OrderedModelClass.patterns('model',model,'electrodes',1:257,'out',257)
